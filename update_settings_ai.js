...
content = content.replace(
  ...
  'upgradeTempleStorage, fetchTempleAiUsage, toggleTempleAiStatus, purchaseAiPlan, fetchAiPlans \n} from \\\'@/app/actions\\\';'
);
...
// 4. Update the settings toggle for 'agi'
// Inside handleToggle, if field is 'agi', also call toggleTempleAiStatus
content = content.replace(
...
const aiModal = \`
      ...
      {isAiModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-300">
           <div className="bg-white rounded-[2rem] shadow-2xl w-full max-w-2xl overflow-hidden flex flex-col border-4 border-white">
