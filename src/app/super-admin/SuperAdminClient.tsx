                                 ...
                                 <tr key={i} className="hover:bg-white transition-colors">
                                    ...
                                    <td className="px-8 py-6">
                                       ...
                                       {!u.isVip && (
                                          <div className="h-1.5 w-full bg-slate-200 rounded-full overflow-hidden">
                                             <div className={`h-full rounded-full transition-all duration-1000 ${usagePercent > 90 ? 'bg-rose-500' : usagePercent > 70 ? 'bg-amber-400' : 'bg-indigo-500'}`} style={{ width: `${usagePercent}%` }}></div>
                                          </div>
                                       )}
                                    </td>
                                    ...
                                    <td className="px-8 py-6 text-right">
                                       <button onClick={async () => {
                                          ...
                                          fetchAllTempleAiUsage().then(setAllTempleAiUsage);
                                       }} className={`px-4 py-2 rounded-full text-[10px] font-black uppercase tracking-widest border transition-all active:scale-95 ${u.isVip ? 'bg-white border-slate-200 text-slate-500 hover:bg-slate-50' : 'bg-slate-900 border-slate-900 text-white shadow-md hover:bg-indigo-600 hover:border-indigo-600'}`}>
