...
export default function GuestAppClient({ templeId, forceLogin }: { templeId: string, forceLogin?: boolean }) {
  ...
  const renderHome = () => {
    ...
    return (
      <main className="max-w-md mx-auto min-h-screen pb-32">
        ...
        <div className="bg-red-700 rounded-b-[2rem] p-6 pb-10 text-white shadow-md relative overflow-hidden">
